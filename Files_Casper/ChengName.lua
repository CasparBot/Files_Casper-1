...
local CasperChengName = redis:get(bot_id.."Casper:Cheng:Name"..data.id_)
if not data.first_name_ then 
if CasperChengName then 
send(msg.chat_id_, msg.id_, "يولد هذا غير اسمه لك ها كلب  ["..CasperChengName..']')
redis:del(bot_id.."Casper:Cheng:Name"..data.id_) 
end
end
...
redis:set(bot_id.."Casper:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
