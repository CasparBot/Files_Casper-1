...
if not redis:get(bot_id..'Casper:Reply:Mute'..msg.chat_id_) then
if text == 'هلو' then
...
redis:del(bot_id..'Casper:Reply:Mute'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'☑┇تم تفعيل ردود البوت')
return false
end

if text == 'تعطيل ردود البوت' and Owner(msg) then
redis:set(bot_id..'Casper:Reply:Mute'..msg.chat_id_,true)
